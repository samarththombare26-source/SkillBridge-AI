...
[![Vite](https://img.shields.io/badge/Build-Vite%208-646CFF?style=flat&logo=vite)](https://vitejs.dev/)
[![Node](https://img.shields.io/badge/Backend-Node%2020-339933?style=flat&logo=node.js)](https://nodejs.org/)
[![Express](https://img.shields.io/badge/Express-5.2-000000?style=flat)](https://expressjs.com/)
[![MongoDB](https://img.shields.io/badge/DB-MongoDB%209-47A248?style=flat&logo=mongodb)](https://www.mongodb.com/)
[![Socket.IO](https://img.shields.io/badge/Realtime-Socket.IO%204-010101?style=flat&logo=socket.io)](https://socket.io/)
...
- [Troubleshooting & QA](#troubleshooting--qa)
- [Roadmap](#roadmap)
...
1. Student browses `/api/internships` (GET) → grid
2. Applies POST `/api/internship-applications` {internshipId} with Bearer token
3. Backend creates `InternshipApplication` (status: pending), recruiter sees applicants GET `/api/internship-applications?internshipId=...`
...
Example cURL is in [Examples](#examples).
